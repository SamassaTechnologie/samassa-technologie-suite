...
window.QRCodeLib = require('/home/claude/node_modules/qrcode');

},{"/home/claude/node_modules/qrcode":2}]},{},[29]);

/* === Wrapper API QRCode compatible avec qrcodejs === */
...
QRCode.prototype.makeCode = function(text) {
  var lvMap = { 0: 'M', 1: 'L', 2: 'H', 3: 'Q' };
  var lvl = lvMap[this._opts.correctLevel] || 'M';
  var self = this;
  window.QRCodeLib.toCanvas(this._canvas, text, {
    errorCorrectionLevel: lvl,
    width: this._opts.width,
    margin: 1,
    color: { dark: this._opts.colorDark, light: this._opts.colorLight }
  }, function(err) {
